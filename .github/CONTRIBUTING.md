...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`BioDataFuse/pyBiodatafuse`](https://github.com/BioDataFuse/pyBiodatafuse)
...
```shell
$ git remote add BioDataFuse https://github.com/BioDataFuse/pyBiodatafuse.git
```
