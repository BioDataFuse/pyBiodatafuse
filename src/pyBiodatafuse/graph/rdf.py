...
def create_data_source_node(g: Graph) -> URIRef: #TODO use this function to create all sources at once (pubchem assays, pathway sites, etc)
        ...
        if data.get("score"):
            ...
            g.add(
                (
                    ...
                    Literal(data["score"], datatype=XSD.double),
                )
            )
