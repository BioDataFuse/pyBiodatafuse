...
class TestOpentarget(unittest.TestCase):
    ...
    def test_get_gene_compound_interactions(self, mock_post_compound):
        ...
        with open(os.path.join(data_file_folder, "opentargets_gene_compound_mock_data.json"), encoding='utf-8') as f:
    ...
    "targets": [
      ...
      },
      {
        ...
        "knownDrugs": {
          "rows": [
            {
              "mechanismOfAction": "Muscle-type nicotinic acetylcholine receptor antagonist",
              "drug": {
                "id": "CHEMBL1201248",
                "name": "CISATRACURIUM",
                "isApproved": true,
            ...
            {
              "mechanismOfAction": "Muscle-type nicotinic acetylcholine receptor agonist",
              "drug": {
                "id": "CHEMBL703",
                "name": "SUXAMETHONIUM",
                "isApproved": true,
