...
def save_dis_sim(kgfile, sim_file):
    ...
    gene_ids = pd.read_csv(
        "/Users/alejandroadriaquelozano/Documents/Internships/MacsBio/KG/disgenet/genes_disgenet.csv"
    )
    diseases_ids = pd.read_csv(
        "/Users/alejandroadriaquelozano/Documents/Internships/MacsBio/KG/disgenet/diseases_disgenet.csv"
    )
    gene_diseases = pd.read_csv(
        "/Users/alejandroadriaquelozano/Documents/Internships/MacsBio/KG/disgenet/gene-disease_disgenet.csv"
    )
